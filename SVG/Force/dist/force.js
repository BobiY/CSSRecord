...
"use strict";
eval("\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\n// 圆形\r\nvar circle_1 = __webpack_require__(/*! ../IBaseGraph/circle */ \"./src/SVGGraph/IBaseGraph/circle.ts\");\r\nvar SVG_NS = 'http://www.w3.org/2000/svg';\r\nvar Circle = /** @class */ (function () {\r\n    function Circle(option) {\r\n        this.cx = 0;\r\n        this.cy = 0;\r\n        this.r = 0;\r\n        this.fill = 'red';\r\n        this.stroke = 'none';\r\n        this.circle = null;\r\n        var cx = option.cx, cy = option.cy, r = option.r, fill = option.fill, stroke = option.stroke;\r\n        this.cx = cx;\r\n        this.cy = cy;\r\n        this.r = r;\r\n        this.fill = fill;\r\n        this.stroke = stroke;\r\n        this.circle = null;\r\n    }\r\n    Circle.prototype.createCircle = function () {\r\n        var _this = this;\r\n        this.circle = document.createElementNS(SVG_NS, 'circle');\r\n        // 设置圆的必要参数参数\r\n        circle_1.PARAM.forEach(function (item) { _this.setAttr(item, \"\" + _this[item]); });\r\n    };\r\n    Circle.prototype.setAttr = function (type, value) {\r\n        this.circle.setAttribute(type, value);\r\n    };\r\n    return Circle;\r\n}());\r\nexports.default = Circle;\r\n\n\n//# sourceURL=webpack://Force/./src/SVGGraph/baseGraph/circle.ts?");
