...
"use strict";
eval("\r\n// 工具函数\r\nObject.defineProperty(exports, \"__esModule\", { value: true });\r\nvar Utils = /** @class */ (function () {\r\n    function Utils() {\r\n        this.getColor = this.getColor.bind(this);\r\n    }\r\n    Utils.getInstance = function () {\r\n        if (!Utils.instance) {\r\n            Utils.instance = new Utils();\r\n        }\r\n        return Utils.instance;\r\n    };\r\n    Utils.prototype.getRandom = function () {\r\n        var rest = [];\r\n        for (var _i = 0; _i < arguments.length; _i++) {\r\n            rest[_i] = arguments[_i];\r\n        }\r\n        // 必须传参数，而且参数只能是两个\r\n        if (!rest || rest.length !== 2) {\r\n            return 0;\r\n        }\r\n        return Math.random() * (rest[1] - rest[0]) + rest[0];\r\n    };\r\n    Utils.prototype.getColor = function (colorCount) {\r\n        var _this = this;\r\n        if (!isFinite(colorCount)) {\r\n            return [];\r\n        }\r\n        return Array(colorCount).fill(0).map(function (item) { return \"hsl(\" + _this.getRandom(0, 360) + \", 100%, 60%)\"; });\r\n    };\r\n    return Utils;\r\n}());\r\nexports.default = Utils;\r\n\n\n//# sourceURL=webpack://Force/./src/Utils.ts?");
